...
class OutlookCOMService:
    ...
    async def analyze_single_email(self, email_id: str, force_reanalysis: bool = True) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            processed_email = await self._ensure_email_analysis(email_data, force_reanalysis=force_reanalysis)
    ...
    async def _ensure_email_analysis(self, email_data: Dict[str, Any], force_reanalysis: bool = False) -> Dict[str, Any]:
        """
            ...
            try:
                ...
                try:
                    ...
                    new_analysis = await asyncio.wait_for(
                        self.intelligence_service.analyze_email(email_data, force_reanalysis=force_reanalysis), 
                        timeout=45.0
                    )
